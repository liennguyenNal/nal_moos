        ...
        <div class="content">
          <div class="container-fluid">
            <div class="content-from">
              ...
              <?php echo $this->Form->create("Contact", array('action'=>'confirm', 'id' => 'form-contact')); ?>
                    ...
                    <table class="from">
                      <tbody>
                          ...
                          <td>
                            <div class="block-input">
                              <div class="div-style">
                                ...
                                <?php echo $this->Form->input('first_name', array('type'=>'text', 'id'=>"first_name", 'label'=>false, 'class'=>'w198', "placeholder"=>"例）山田",'div'=>false, 'data-placement' => 'right', 'disabled', 'value'=>$contact['Contact']['first_name']))
                                ?>
                              </div>
                              <div class="div-style">
                                <span class="w-auto"><?php echo __('user.register.lastname'); ?></span>
                                <?php echo $this->Form->input('last_name', array('type'=>'text', 'id'=>"last_name", 'label'=>false, 'class'=>'w198', "placeholder"=>"太郎",'div'=>false, 'data-placement' => 'right','disabled', 'value'=>$contact['Contact']['last_name']))
                                ?>
                              </div>
                            </div>
                            <div class="block-input">
                              <div class="div-style">
                                ...
                                <?php echo $this->Form->input('first_name_kana', array('type'=>'text', 'id'=>"first_name_kana", 'label'=>false, 'class'=>'w198', "placeholder"=>"ヤマダ",'div'=>false, 'data-placement' => 'right','disabled', 'value'=>$contact['Contact']['first_name_kana']))
                                ?>
                              </div>
                              <div class="div-style">
                                <span class="w-auto"><?php echo __('user.register.lastnamekana'); ?></span>
                                <?php echo $this->Form->input('last_name_kana', array('type'=>'text', 'id'=>"last_name_kana", 'label'=>false, 'class'=>'w198', "placeholder"=>"タロウ",'div'=>false, 'data-placement' => 'right','disabled', 'value'=>$contact['Contact']['last_name_kana']))
                                ?>
                              </div>
                            </div>
                          </td>
                            ...
                            <div class="form-radio">
                              <div class="form-w">
                                <div class="block-input-radio">
                                  <?php 
                                    echo $this->Form->radio('type', array('1'=> __('user.contact.customer'), '2'=> __('user.contact.marketing'), '3' => __('user.contact.constructure'), '4' => __('global.other')), array( 'class'=>'radio', 'label'=>false, 'div'=>false, 'legend'=>false, 'default'=>false, 'class'=>'fix-pd', 'required'=>false, 'data-placement' => 'right','disabled', 'value'=>$contact['Contact']['type']));
                                  ?>
                                </div>
                              </div>
                            </div>
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="block-input">
                              <?php echo $this->Form->input('company', array('type'=>'text', 'id'=>"comapny_name", 'label'=>false, 'class'=>'w198', 'div'=>false, 'required'=>false,'disabled', 'value'=>$contact['Contact']['company']))
                              ?>
                            </div>
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td>
                              <?php echo $this->Form->input('phone', array('type'=>'text', 'id'=>"phone", 'label'=>false, 'class'=>'w40', 'div'=>false, 'placeholder'=>"例）09012345678", 'required'=>false, 'data-placement' => 'right','disabled', 'value'=>$contact['Contact']['phone']))
                              ?>
                        ...
                        <tr>
                          ...
                          <td>
                            <?php echo $this->Form->input('email', array('type'=>'text', 'id'=>"email", 'label'=>false, 'class'=>'w40 input-style', 'div'=>false, 'required'=>false, 'data-placement' => 'right', 'placeholder'=>"例）sample@gmail.com",'disabled', 'value'=>$contact['Contact']['email']))
                            ?>
                        ...
                        <tr>
                          ...
                          <td>
                            <?php echo $this->Form->input('email_confirm', array('type'=>'text', 'id'=>"email_confirm", 'label'=>false, 'class'=>'w40 input-style', 'div'=>false,  'required'=>false, 'data-placement' => 'right', 'placeholder'=>"sample@gmail.com",'disabled', 'value'=>$contact['Contact']['email_confirm']))
                            ?>
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td>
                            <?php echo $this->Form->input('content', array('type'=>'textarea', 'id'=>"content", 'label'=>false, 'rows'=>4, 'cols'=> 50, 'div'=>false, 'required'=>false, 'data-placement' => 'right','disabled', 'value'=>$contact['Contact']['content']))
                            ?>
                          </td>
                        </tr>
                      </tbody>
                    ...
                    <div class="block-button">
                      <div class="block-input-check">
                        <div class="block">
                          ...
                          <?php
                          echo $this->Form->input('agree',array('type'=>'checkbox','options'=>array("1"=>"1"),'div'=>false, 'label'=>false, 'id' => 'agree', 'data-placement' => 'right','disabled', "checked"));
                          ?>
