					...
					<div class="container-fluid">
						<ul>
							<li>
								...
								<div class="block-2">
									<span class="icon"></span>
									<p><span>本当です。カスタマイズによって算出される家賃を、</br>お支払いいただくことで、その家がお客様のものになります。</span></p>
								</div>
							</li>
							<li>
								<div class="block-1">
								...
								<div class="block-2">
									<span class="icon"></span>
									<p><span>はい、できます。アパートやマンションと同じ賃貸住宅の入居審査だけです。</span></p>
								</div>
							</li>
							<li>
								<div class="block-1">
				                        ...
				                        <tr>
				                          ...
				                          <td>
				                            ...
				                            <div class="block-input">
				                              ...
				                              <?php echo $this->Form->input("ExpectArea.$i.address", array('type'=>'text', 'id'=>"address", 'label'=>false, 'class'=>'w198', "placeholder"=>'１〜４丁目、◯◯◯中学校区など', 'style'=>'line-height: 14px;','div'=>false, 'data-placement' => 'right', 'required'=>false))
				                              ?>
				                            </div>
				                          </td>
				                        </tr>
