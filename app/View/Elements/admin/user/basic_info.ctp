                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-10">
                    <?php 
                      ...
                      echo $this->Form->input('UserCompany.salary_date', array('type'=>'text', 'id'=>"salary_date", 'label'=>__('user.my_page.basic_info.salary_date'), 'class'=>'form-control','div'=>false, 'style'=>'width:200px; display:inline'))
                    ?>日
                  </div>
                </div>
