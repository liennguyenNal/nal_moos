	              ...
	              <fieldset>
	                <div class="form-group">
	                  ...
	                  <div class="col-lg-10">
	                    ...
	                    <?php 
	                    echo $this->Form->select('OtherGuarantor.work_id', $works, array('class'=>'form-control', 'style'=>'width:250px;','div'=>false, 'label'=>false, 'id'=>'working_status', 'empty'=>'--------'));
	                  ?>
	                  </div>
	                </div>
	                <div class="form-group">
	              ...
	              <tr>
	                ...
	                <div class="form-group">
	                  ...
	                  <div class="col-lg-10">
	                    <?php 
	                		...
	                		echo $this->Form->input('OtherGuarantor.salary_type_other', array('type'=>'text', 'id'=>"g_salary_type_other", 'label'=>false, 'class'=>'form-control','div'=>false, 'disabled'=>true, 'required'=>false, 'style'=>'width:200px; display:inline;'))
	              		?>	
	                  </div>
	                  	<script type="text/javascript">
	               ...
	               <div class="form-group">
	                ...
	                <div class="form-group">
	                  ...
	                  <div class="col-lg-10">
	                    <?php echo $this->Form->input('OtherGuarantor.income_year', array('type'=>'text', 'id'=>"salary_year", 'label'=>false, 'class'=>'form-control','div'=>false, 'required'=>false,'style'=>'width:150px; display:inline;'))?><?php echo __('user.register.yen'); ?>
	                  </div>
	                </div>
