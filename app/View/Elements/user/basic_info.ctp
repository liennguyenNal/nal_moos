                  ...
                  <tr>
                    ...
                    <td>
                      <div class="block-input">
                        ...
                        <?php echo $this->Form->input('UserCompany.name', array('type'=>'text', 'id'=>"b_company_name", 'label'=>false, 'class'=>'w198', 'div'=>false, 'data-placement'=>'right', 'required'=>false, 'placeholder'=>'株式会社ヤチンデモラエル'))
                        ?>
                      </div>
                      <div class="block-input">
