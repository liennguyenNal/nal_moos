...
<div class="title-tab">
  ...
  <div style="width:69%; text-align:right;" class="button-tab dash_board_top_button">
...
<div id="first_login" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <p>【お手続きの流れ】</p>
      <ul>
          <li><p>家賃でもらえる家の建築開始までには、入居審査・各種お手続きが必要となります。</p></li>
          <li><p>まずは、下記手順に従って入居審査のお申し込みをお願い致します。</p><br/></li>
