              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <div class="select">
                      <?php 
                        echo $this->Form->select('UserPartner.work_id', $works, array('class'=>'w198','div'=>false, 'label'=>false, 'id'=>'working_status', 'empty'=>'--------'));
                      ?>
                    </div>
                  </td>
                </tr> 
                ...
                <tr>
                  ...
                  <td>
                    <div class="select">
                      <?php 
                        echo $this->Form->select('UserPartner.insurance_id', $insurances, array('class'=>'w198', 'div'=>false, 'label'=>false, 'id'=>'working_status', 'empty'=>'--------', 'data-placement'=>'right'));
                      ?>
                    </div>
                  </td>
                </tr>
