    ...
    <div class="row">
      	<div class="col-lg-12">
	        ...
	        <div class="well bs-component">
	            ...
	            <?php echo $this->Form->hidden('UserGuarantor.is_confirm', array('value'=> $is_confirm, 'id'=>'guarantor_id'))?>
	            <?php if($user['User']['status_id'] == 2){?>
              <div class="form-group">
                <div class="col-lg-10 col-lg-offset-2">
                  <button type="submit" class="btn btn-primary" id="btn-confirm-guarantor" >Confirm</button>
                  <button type="button" class="btn btn-primary" id="btn-save-guarantor" >Save</button>
               ...
               <?php }
                ...
                $('#UserGuarantorEdit').find(':button').hide();
                $('#UserGuarantorEdit').find(':input').prop('disabled',true);
                </script>
              <?php }?>
                <script type="text/javascript" >
                <?php if($is_confirm == 1){?>
                  $('#btn-confirm-guarantor').hide();
                  $('#btn-save-guarantor').show();
                  $('#btn-cancel-guarantor').show();
                  $('#UserGuarantorEdit').find(':button:not(#btn-save-guarantor):not(#btn-cancel-guarantor)').hide();
                  $('#UserGuarantorEdit').find(':input:not(:disabled):not(:hidden):not(#btn-save-guarantor):not(#btn-cancel-guarantor)').prop('disabled',true);
                <?php }else {?>
                   $('#btn-confirm-guarantor').show();
                ...
                <?php } ?>    
                   ...
                   $('#btn-cancel-guarantor').on('click', function() {
                      $('#UserGuarantorEdit').find(':input:not(#btn-save-guarantor):not(#btn-cancel-guarantor)').prop('disabled',false);
                      $('#btn-cancel-guarantor').hide();
                      $('#btn-save-guarantor').hide();
                      $('#btn-confirm-guarantor').show();
                      $('#UserGuarantorEdit').find(':button:not(#btn-save-guarantor):not(#btn-cancel-guarantor)').show();
                      $('#partner_id').val("");

                   });
                  $('#btn-save-guarantor').on('click', function(){
                      $.ajax({
                        url: "<?php echo $this->webroot?>user_guarantors/edit", 
                        'method':'POST',
                        'data':"data[UserGuarantor][is_confirm]=1",
