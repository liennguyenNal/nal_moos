                        ...
                        <tr>
                          ...
                          <td>
                            <div class="block-input">
                              ...
                              <?php echo $this->Form->input('UserCompany.salary_year', array('type'=>'text', 'id'=>"salary_year", 'label'=>false, 'class'=>'w108','div'=>false, 'placeholder'=>'00', "value"=>$user['UserCompany']['salary_year']))
                              ?>
