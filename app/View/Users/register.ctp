      ...
      <div class="col-lg-12">
        ...
        <?php echo $this->element('flash');?>
         <!--  <form class="form-horizontal"> -->
          <?php echo $this->Form->create("User", array('action'=>'register', 'class'=>'form-horizontal', 'inputDefaults' => array(
        'format' => array('before', 'label', 'between', 'input', 'after',  'error'  ) ) ) ) ?>
            <fieldset>
              ...
              <div class="form-group">
                <label for="inputEmail" class="col-lg-2 control-label">Last Name Kana<span style="color:red">*<span></label>
                <div class="col-lg-10">
              ...
              <div class="form-group">
                <label for="inputEmail" class="col-lg-2 control-label">Home Phone</label>
                <div class="col-lg-10">
