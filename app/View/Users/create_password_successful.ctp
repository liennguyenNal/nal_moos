										...
										<div class="content-from-block">
											...
											<div class="block-note">
												<div class="block-button">
													<button type="button" class="style"><img src="<?php echo $this->webroot; ?>img/front/text-from-b.png" alt="ログイン画面へ" onclick="location.href='<?php echo $this->webroot; ?>users/login'"/></button>
												</div>
											</div>
										</div>
									</form>
