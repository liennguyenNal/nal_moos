          	...
          	<div class="tab-pane fade active in" id="profile">
		        ...
		        <div class="form-group">
		            <div class="col-lg-10 col-lg-offset-2">
		              <button type="button" class="btn btn-primary" onclick="approve();">Approve Register</button>
		              <button type="button" class="btn btn-primary" onclick="reject()"> Reject Register</button>
		            </div>
		          </div>
		      </div>
		      <?php } ?>
