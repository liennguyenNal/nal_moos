...
<html>
<head>
  <title>お問い合わせ｜家賃でもらえる家</title>
  <meta http-equiv="Content-type" content="text/html;charset=UTF-8" />
  <meta name="description" content = "「家賃でもらえる家」のお問い合わせページです。お名前、ご連絡先と併せて、お問い合わせの分類、詳しいお問い合わせ内容・ご依頼内容の記載をお願いいたします。" />
  <meta name="keywords" content="家、家賃、賃貸、住宅ローン審査、入居審査、マイホーム、お問い合わせ" />
