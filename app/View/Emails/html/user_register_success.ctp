...
<p style=" margin:0px !important"><a href="<?php echo Router::url('/', true) ?>introduction">家賃でもらえる家とは</a></p>
<p style=" margin:0px !important">&nbsp;</p>
<p style=" margin:0px !important">☆家賃で家がもらえるまで</p>
<p style=" margin:0px !important"><a href="<?php echo Router::url('/', true) ?>work_flow">お申し込みの流れ</a></p>
<p style=" margin:0px !important">&nbsp;</p>
<p style=" margin:0px !important">=========================================</p>
