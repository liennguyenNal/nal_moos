...
<p style=" margin:0px !important">&nbsp;</p>
<p style=" margin:0px !important">以下のログイン画面より、ユーザーID(ご登録のメールアドレス)と設定いただいたパスワードを入力し、マイページにログインしてください。</p>
<p style=" margin:0px !important">&nbsp;</p>
<p style=" margin:0px !important"><a href="<?php echo str_replace("http:", "https:" ,Router::url('/', true) ) ;?>users/login"><?php echo Router::url('/', true) ?>users/login</a></p>
<p style=" margin:0px !important">&nbsp;</p>
